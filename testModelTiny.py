...
# You can also custom the following module by pytorch
...
if __name__ == "__main__":
    print("Initializing CGRSeg-Tiny (Standalone)...")
    model = CGRSeg_Tiny_Standalone(num_classes=150, input_size=512)
    model.eval()
    
    # Calculate params
    total_params = sum(p.numel() for p in model.parameters())
    print(f"Total Parameters: {total_params / 1e6:.2f} M") # Expected: Approx ~4.7M to 5.0M
